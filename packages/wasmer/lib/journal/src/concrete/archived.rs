...
use rkyv::{
    api::serialize_using, Archive, Deserialize as RkyvDeserialize,
...
pub const JOURNAL_MAGIC_NUMBER_BYTES: [u8; 8] =
    JOURNAL_MAGIC_NUMBER.to_be_bytes();
...
impl JournalEntryRecordType {
    ...
    pub unsafe fn deserialize_archive(
        self,
        data: &[u8],
    ) -> anyhow::Result<JournalEntry<'_>> {
        match self {
            ...
            JournalEntryRecordType::ClearEtherealV1 => {
                ArchivedJournalEntry::ClearEtherealV1(rkyv::access_unchecked(
                    data,
                ))
            }
            ...
            JournalEntryRecordType::SetClockTimeV1 => {
                ArchivedJournalEntry::SetClockTimeV1(rkyv::access_unchecked(
                    data,
                ))
            }
            ...
            JournalEntryRecordType::CreateDirectoryV1 => {
                ArchivedJournalEntry::CreateDirectoryV1(rkyv::access_unchecked(
                    data,
                ))
            }
            JournalEntryRecordType::RemoveDirectoryV1 => {
                ArchivedJournalEntry::RemoveDirectoryV1(rkyv::access_unchecked(
                    data,
                ))
            }
            JournalEntryRecordType::PathSetTimesV1 => {
                ArchivedJournalEntry::PathSetTimesV1(rkyv::access_unchecked(
                    data,
                ))
            }
            ...
            JournalEntryRecordType::CreateHardLinkV1 => {
                ArchivedJournalEntry::CreateHardLinkV1(rkyv::access_unchecked(
                    data,
                ))
            }
            ...
            JournalEntryRecordType::ChangeDirectoryV1 => {
                ArchivedJournalEntry::ChangeDirectoryV1(rkyv::access_unchecked(
                    data,
                ))
            }
            ...
            JournalEntryRecordType::PortAddrClearV1 => {
                return Ok(JournalEntry::PortAddrClearV1)
            }
            JournalEntryRecordType::PortBridgeV1 => {
                ArchivedJournalEntry::PortBridgeV1(rkyv::access_unchecked(data))
            }
            JournalEntryRecordType::PortUnbridgeV1 => {
                return Ok(JournalEntry::PortUnbridgeV1)
            }
            JournalEntryRecordType::PortDhcpAcquireV1 => {
                return Ok(JournalEntry::PortDhcpAcquireV1)
            }
            JournalEntryRecordType::PortGatewaySetV1 => {
                ArchivedJournalEntry::PortGatewaySetV1(rkyv::access_unchecked(
                    data,
                ))
            }
            JournalEntryRecordType::PortRouteAddV1 => {
                ArchivedJournalEntry::PortRouteAddV1(rkyv::access_unchecked(
                    data,
                ))
            }
            JournalEntryRecordType::PortRouteClearV1 => {
                return Ok(JournalEntry::PortRouteClearV1)
            }
            JournalEntryRecordType::PortRouteDelV1 => {
                ArchivedJournalEntry::PortRouteDelV1(rkyv::access_unchecked(
                    data,
                ))
            }
            ...
            JournalEntryRecordType::SocketListenV1 => {
                ArchivedJournalEntry::SocketListenV1(rkyv::access_unchecked(
                    data,
                ))
            }
            ...
            JournalEntryRecordType::SocketConnectedV1 => {
                ArchivedJournalEntry::SocketConnectedV1(rkyv::access_unchecked(
                    data,
                ))
            }
            JournalEntryRecordType::SocketAcceptedV1 => {
                ArchivedJournalEntry::SocketAcceptedV1(rkyv::access_unchecked(
                    data,
                ))
            }
            ...
            JournalEntryRecordType::SocketSendFileV1 => {
                ArchivedJournalEntry::SocketSendFileV1(rkyv::access_unchecked(
                    data,
                ))
            }
            JournalEntryRecordType::SocketSendToV1 => {
                ArchivedJournalEntry::SocketSendToV1(rkyv::access_unchecked(
                    data,
                ))
            }
            ...
            JournalEntryRecordType::SocketSetOptFlagV1 => {
                ArchivedJournalEntry::SocketSetOptFlagV1(rkyv::access_unchecked(
                    data,
                ))
            }
            JournalEntryRecordType::SocketSetOptSizeV1 => {
                ArchivedJournalEntry::SocketSetOptSizeV1(rkyv::access_unchecked(
                    data,
                ))
            }
            JournalEntryRecordType::SocketSetOptTimeV1 => {
                ArchivedJournalEntry::SocketSetOptTimeV1(rkyv::access_unchecked(
                    data,
                ))
            }
            JournalEntryRecordType::SocketShutdownV1 => {
                ArchivedJournalEntry::SocketShutdownV1(rkyv::access_unchecked(
                    data,
                ))
            }
...
impl<'a> JournalEntry<'a> {
    ...
    {
        let amt = match self {
            JournalEntry::InitModuleV1 { wasm_hash } => serialize_using(
                &JournalEntryInitModuleV1 { wasm_hash },
                serializer,
            ),
            ...
            JournalEntry::CloseFileDescriptorV1 { fd } => serialize_using(
                &JournalEntryCloseFileDescriptorV1 { fd },
                serializer,
            ),
            ...
            JournalEntry::CreatePipeV1 { fd1, fd2 } => serialize_using(
                &JournalEntryCreatePipeV1 { fd1, fd2 },
                serializer,
            ),
            ...
            JournalEntry::PortAddAddrV1 { cidr } => serialize_using(
                &JournalEntryPortAddAddrV1 { cidr: cidr.into() },
                serializer,
            ),
            ...
            JournalEntry::SocketListenV1 { fd, backlog } => serialize_using(
                &JournalEntrySocketListenV1 { fd, backlog },
                serializer,
            ),
            JournalEntry::SocketBindV1 { fd, addr } => serialize_using(
                &JournalEntrySocketBindV1 { fd, addr },
                serializer,
            ),
        ...
        .map_err(|err| {
            anyhow::format_err!("failed to serialize journal record - {}", err)
        })?;
        Ok(amt)
    }
}
...
pub enum ArchivedJournalEntry<'a> {
    ...
    SocketLeaveIpv4MulticastV1(
        &'a ArchivedJournalEntrySocketLeaveIpv4MulticastV1,
    ),
    SocketLeaveIpv6MulticastV1(
        &'a ArchivedJournalEntrySocketLeaveIpv6MulticastV1,
    ),
